...
import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, o as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, p as renderUniqueStylesheet, q as renderScriptElement, t as createHeadAndContent, r as renderComponent, a as AstroUserError } from './astro/server_DHwBEDxI.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DMBXlewF.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://www.pasthk.com", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BlW3q3R0.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_J4DGijRi.mjs');
...
const starlightConfig = {"description":"香港考古學文獻索引及綜述","tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"0","translations":{},"collapsed":false,"items":[{"translations":{},"slug":"foreword","attrs":{}}]},{"label":"1","translations":{},"collapsed":false,"items":[{"translations":{},"slug":"chapter-one/early-survey-1920s-to-1950s","attrs":{}},{"translations":{},"slug":"chapter-one/hong-kong-archaeological-survey-1982-to-1985","attrs":{}},{"translations":{},"slug":"chapter-one/hong-kong-archaeological-survey-1995-to-1997","attrs":{}}]},{"label":"2","translations":{},"collapsed":false,"items":[{"translations":{},"slug":"afterword","attrs":{}}]}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"pagefind":{"ranking":{"pageLength":0.1,"termFrequency":0.1,"termSaturation":2,"termSimilarity":9}},"title":{"zh-HK":"考鏡香江源流"},"isMultilingual":false,"defaultLocale":{"label":"中文（香港）","lang":"zh-HK","dir":"ltr"}};

const project = {"build":{"format":"file"},"root":"file:///Volumes/Data/WebCode/pasthk.github.io/","srcDir":"file:///Volumes/Data/WebCode/pasthk.github.io/src/","trailingSlash":"ignore"};
...
export { BuiltInDefaultLocale as B, DEFAULT_OUTPUT_FORMAT as D, VALID_SUPPORTED_FORMATS as V, stripTrailingSlash as a, stripLeadingSlash as b, stripHtmlExtension as c, ensureTrailingSlash as d, ensureHtmlExtension as e, getCollectionPathFromRoot as f, getCollection as g, pickLang as h, stripLeadingAndTrailingSlashes as i, ensureLeadingSlash as j, stripExtension as k, getEntry as l, DEFAULT_HASH_PROPS as m, getCollectionPath as n, project as p, renderEntry as r, starlightConfig as s, useTranslations as u };
