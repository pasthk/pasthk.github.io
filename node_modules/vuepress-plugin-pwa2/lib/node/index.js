...
`)},F=(e={},a=!1)=>n=>{a&&$(e),n.env.isDebug&&u.info("Options:",e);const{base:t,shouldPrefetch:o=!0}=n.options;e.appendBase&&H(t,e),o===!0&&u.warn('The plugin will register service worker to handle assets, so we recommend you to set "shouldPrefetch: false" in VuePress config file.');const c=W(n,e);return n.options.head=E(e,t,n.options.head),I(n,{id:"hope"}),{name:"vuepress-plugin-pwa2",define:()=>({PWA_LOCALES:j({app:n,name:"pwa",default:k,config:e.locales}),SW_FORCE_UPDATE:e.update==="force",SW_PATH:e.swPath||"service-worker.js"}),extendsBundlerOptions:(i,s)=>{x(i,s,["mitt","register-service-worker"]),C(i,s,{path:"/manifest.webmanifest",response:async(r,l)=>(l.setHeader("Content-Type","application/manifest+json"),JSON.stringify(await c)),errMsg:"Unexpected manifest generate error"})},onGenerated:async i=>{await N(i,c),await B(i,e)},clientConfigFile:i=>M(i,e)}};export{k as pwaLocales,F as pwaPlugin};
