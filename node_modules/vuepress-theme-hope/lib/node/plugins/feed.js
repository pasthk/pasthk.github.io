...
export const getFeedPlugin = (themeData, options = {}, hostname, favicon, legacy = false) => {
    ...
    const defaultOptions = {
        ...
        locales: Object.fromEntries(Object.entries(themeData.locales).map(([localePath, { logo, author, copyright }]) => {
    ...
    return feedPlugin(deepAssign(defaultOptions, options, {
        // merge removedElements
        removedElements: isFunction(removedElements)
            ? (tagName) => themeComponents.includes(tagName) || removedElements(tagName)
